        ...
        steps: [
          {
            ...
            options: [
              { name: "Cerdo Frito", price: 389 },
              { name: "Cerdo al Vapor", price: 389 },
              { name: "Pollo Frito", price: 389 },
              { name: "Pollo al Vapor", price: 389 },
            ],
          },
        ],
      },
        ...
        steps: [
          {
            ...
            options: [
              { name: "Edamame Al vapor", price: 550 },
              { name: "Edamame Asado", price: 550 },
            ],
          },
          {
            label: "Elige el Rollo 1",
            options: [
              { name: "Yamato Roll", price: 0 },
              { name: "Ebi Roll", price: 0 },
              { name: "Sesame Roll", price: 0 },
              { name: "Boston Roll", price: 0 },
              { name: "Zambo Roll", price: 0 },
              { name: "Kani Kama Roll", price: 0 },
              { name: "Nemo Roll", price: 0 },
              { name: "Alaska Roll", price: 0 },
              { name: "Sofia Roll", price: 0 },
              { name: "Hokkaido Roll", price: 0 },
              { name: "Wakame Roll", price: 0 },
              { name: "Osaka Roll", price: 0 },
              { name: "Chicken Roll", price: 0 },
              { name: "Abokado Roll", price: 0 },
              { name: "Catracho Roll", price: 0 },
            ],
          },
          {
